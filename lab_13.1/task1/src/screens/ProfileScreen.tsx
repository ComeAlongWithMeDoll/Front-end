...
const styles = StyleSheet.create({
  ...
  statsContainer: { flexDirection: 'row', backgroundColor: '#ffffff', borderRadius: 12, padding: 20, marginBottom: 24, elevation: 3 },
  ...
  infoLabel: { fontSize: 12, color: '#999', marginTop: 12 },
